...
namespace zich{
    ...
    bool operator ==(Matrix const &mat1,Matrix const &mat2){
        ...
        for (int i = 0; i < mat1.getRow(); i++){
            for (int j = 0; j < mat1.getCol(); j++){
                if (mat1.getData()[(unsigned int)(i * mat1.getCol() + j)] != mat2.getData()[(unsigned int)(i * mat2.getCol() + j)]){
                    return false;
                    }
                }
            }
    ...
    Matrix Matrix::operator*(const Matrix &mat){
        ...
        for (int i = 0; i < getRow(); i++){
            for (int j = 0; j < mat.getCol(); j++){
                mat3_data[(unsigned int)(i * mat.getCol() + j)] = mul(mat, i, j);
            }
        }
    ...
    Matrix Matrix::operator*(const double scalar){
        ...
        for (int i = 0; i < getRow(); i++){
            for (int j = 0; j < getCol(); j++){
                if (getData()[(unsigned int)(i * getCol() + j)] == 0){
                    continue;
                }
            mat3_data[(unsigned int)(i * getCol() + j)] = getData()[(unsigned int)(i * getCol() + j)] * scalar;
            }
        }
    ...
    Matrix operator*(const double scalar, Matrix &mat){
        ...
        for (int i = 0; i < mat.getRow(); i++){
            for (int j = 0; j < mat.getCol(); j++){
                if (mat._data[(unsigned int)(i * mat.getCol() + j)] == 0){
                    continue;
                }
                mat3_data[(unsigned int)(i * mat.getCol() + j)] = scalar * mat.getData()[(unsigned int)(i * mat.getCol() + j)];
            }
        }
    ...
    Matrix Matrix::operator+(Matrix const &mat){
        ...
        for (int i = 0; i < _row; i++){
            ...
            mat3_data[(unsigned int)(i * _col + j)] = getData()[(unsigned int)(i * _col + j)] + mat.getData()[(unsigned int)(i * _col + j)];
            }
        }
        Matrix mat3(mat3_data, getRow(), mat.getCol());
        return mat3;
    ...
    Matrix operator+(Matrix &mat){
        ...
        for (int i = 0; i < mat.getRow(); i++){
            for (int j = 0; j < mat.getCol(); j++){
                if (mat.getData()[(unsigned int)(i * mat.getCol() + j)] == 0){
                    continue;
                    }
                mat3_data[(unsigned int)(i * mat.getCol() + j)] = mat.getData()[(unsigned int)(i * mat.getCol() + j)];
            }
        }
        Matrix mat3(mat3_data, mat.getRow(), mat.getCol());
        return mat3;
    ...
    Matrix &Matrix::operator++(){
        for (int i = 0; i < getRow(); i++){
            for (int j = 0; j < getCol(); j++){
                this->_data[(unsigned int)(i * _col + j)] += 1;
            }
        }
        return *this;
    }
    ...
    double Matrix::mul(const Matrix &mat, const int tempRow, const int tempCol){
        ...
        for (int i = 0; i < getCol(); i++){
            sum += getData()[(unsigned int)(getCol() * tempRow + i)] * mat.getData()[(unsigned int)(mat.getCol() * i + tempCol)];
        }
        return sum;
    }
    Matrix &Matrix::operator*=(const double scalar){
        for (int i = 0; i < getRow(); i++){
            for (int j = 0; j < getCol(); j++){
                ...
                this->_data[(unsigned int)(i * getCol() + j)] *= scalar;
            }
        }
        return *this;
    }
    ...
    Matrix operator-(Matrix &mat){
        ...
        for (int i = 0; i < mat.getRow(); i++){
            for (int j = 0; j < mat.getCol(); j++){
                ...
                mat3_data[(unsigned int)(i * mat.getCol() + j)] = (-1) * mat.getData()[(unsigned int)(i * mat.getCol() + j)];
            }
        }
        Matrix mat3(mat3_data, mat.getRow(), mat.getCol());
        return mat3;
    ...
    Matrix &Matrix::operator+=(const Matrix &mat){
        ...
        for (int i = 0; i < getRow(); i++){
            for (int j = 0; j < getCol(); j++){
                this->_data[(unsigned int)(i * _col + j)] += mat.getData()[(unsigned int)(i * _col + j)];
            }
        }
        return *this;
    }
    ...
    istream &operator>>(istream &input, Matrix &mat){
        ...
        for (unsigned int i = 0; i < s.length()-1; i++){
            if (s.at(i) == ',' && s.at(i+1) != ' '){
                throw invalid_argument("String worng");
            }
        }
    ...
    bool Matrix::operator!=(Matrix &mat){
        ...
        for (int i = 0; i < getRow(); i++){
            for (int j = 0; j < getCol(); j++){
                if (getData()[(unsigned int)(i * _col + j)] != mat.getData()[(unsigned int)(i * _col + j)]){
                    return true;
                }
            }
        }
